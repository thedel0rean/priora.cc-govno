...
#include "..\features\misc\animation fix\setup bones\setup_bones.h"
...
void player_t::invalidate_bone_cache()
{
	...
	static auto m_InvalidateBoneCache = (util::FindSignature(crypt_str("client.dll"), crypt_str("80 ? ? ? ? ? ? 74 16 A1 ? ? ? ? 48 C7 ? ? ? ? ? ? ? ? ? 89 ? ? ? ? ? C3")));

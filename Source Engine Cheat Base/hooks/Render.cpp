...
#include "../features/visuals/world/nades/prediction.h"
#include "../menu/menu.h"
...
void  ImGuiRendering::AddRadialGradient(ImDrawList* draw_list, const ImVec2& center, float radius, ImU32 col_in, ImU32 col_out)
{
	...
	draw_list->PathArcToFast(center, radius, 0, IM_DRAWLIST_ARCFAST_SAMPLE_MAX);

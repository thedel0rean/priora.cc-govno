...
#include "..\hooks.hpp"
#include "..\..\menu\menu.h"
#include "..\..\features\misc\animation fix\animation_system.h"
#include "..\..\features\visuals\esp\player_esp.h"
#include "..\..\features\visuals\esp\other_esp.h"
#include "..\..\features\misc\logs.h"
#include "..\..\features\visuals\world\world_esp.h"
#include "..\..\features\misc\misc.h"
#include "..\..\features\visuals\world\nades\prediction.h"
#include "..\..\features\visuals\tracers\tracers.h"
#include "..\..\features\visuals\esp\esp.h"
#include "..\..\features\misc\animation fix\local_animations.h"
...
void __fastcall hooks::hooked_painttraverse(void* ecx, void* edx, vgui::VPANEL panel, bool force_repaint, bool allow_force)
{
	...
	if (set_console)
	{
		...
		string changelogs = crypt_str(DownloadString("https://raw.githubusercontent.com/crys1337/priorityccloader/main/changelog"));
		...
		m_cvar()->ConsoleColorPrintf(Color(142, 148, 225), crypt_str(u8"⢛⣽⡟⠁⠄⠄⣀⡠⠔⠂⠈⠄⠄⠄⡀⠠⡀⠄⠄⠄⠄⠄⠄⠉⠉⠛⠿⢶⣦⣤⣄⣘⢦                              \n"));
		m_cvar()->ConsoleColorPrintf(Color(142, 148, 225), crypt_str(u8"⣾⠏⢀⣠⡶⠛⠁⠄⠄⠄⣰⠄⠄⣼⣷⡀⢻⣷⣤⡀⠄⢀⡀⠄⠄⠄⠄⠄⠈⠙⠻⣿⣿								\n"));
		m_cvar()->ConsoleColorPrintf(Color(142, 148, 225), crypt_str(u8"⣯⣴⠟⠋⠄⠄⠄⢠⡎⢰⣿⡇⢰⣿⣿⣿⣜⣿⣿⣿⣄⠘⣿⣄⠄⠄⠄⠄⠄⠄⠄⠄⠙								\n"));
		m_cvar()->ConsoleColorPrintf(Color(142, 148, 225), crypt_str(u8"⠟⠁⠄⠄⠄⠄⢠⣿⣇⣿⠿⢻⣸⣿⣿⣟⢉⡛⠻⠿⣿⣷⣿⣿⡆⣦⠄⠄⠄⠄⠄⠄⠄								\n"));
		m_cvar()->ConsoleColorPrintf(Color(142, 148, 225), crypt_str(u8"⠄⠄⠄⠄⣠⡇⣾⣿⣭⣶⣾⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣧⠄⠄⠄⠄⠄⠄								\n"));
		...
		m_cvar()->ConsoleColorPrintf(Color(142, 148, 225), crypt_str(u8"⠄⠄⠄⠄⠄⠄⠄⠄⠉⠛⠿⣿⣿⣿⣶⣶⣶⣿⣿⣿⣿⠟⠋⠁⠄⠄⠄⠄⠄⠄⠄⠄⠄								\n"));
		m_cvar()->ConsoleColorPrintf(Color(142, 148, 225), crypt_str(u8"⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠈⠙⠛⠿⠿⠟⠋⠉⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄								\n\n"));
		m_cvar()->ConsoleColorPrintf(Color(146, 196, 255), crypt_str(u8"priority.cc\n"));
		m_cvar()->ConsoleColorPrintf(Color(146, 196, 255), crypt_str(u8"change-log:\n"));
		m_cvar()->ConsoleColorPrintf(Color(146, 196, 255), crypt_str(changelogs).c_str());
	}

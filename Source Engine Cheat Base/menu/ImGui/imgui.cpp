...
bool ImGui::beginchildex(const char* name, ImGuiID id, const ImVec2& size_arg, bool border, ImGuiWindowFlags flags)
{
    ...
    parent_window->DrawList->AddRectFilled(ImGui::GetWindowPos() + ImVec2(0, border ? 20 : 5), ImGui::GetWindowPos() + size_arg, ImColor(7, 7, 7)); //bg
    parent_window->DrawList->AddRectFilled(ImGui::GetWindowPos() + ImVec2(0, border ? 20 : 5), ImGui::GetWindowPos() + ImVec2(size_arg.x, 25), ImColor(7, 7, 7)); //top
    ...
    parent_window->DrawList->AddLine(ImGui::GetWindowPos() + ImVec2(0, 25), ImGui::GetWindowPos() + ImVec2(size_arg.x - 0.5, 25), ImColor(142, 148, 255)); // seperator

...
//    IMGUI_API bool          tab(const char* icon, const char* label, bool selected);
    IMGUI_API bool          TabEx(const char* icon, const char* label, int number, bool* active, const ImVec2& size_arg, ImGuiButtonFlags flags);
    IMGUI_API bool          Tab(const char* icon, const char* label, int number, bool active, const ImVec2& size_arg);

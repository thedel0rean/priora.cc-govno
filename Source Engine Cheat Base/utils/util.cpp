...
//                     	m	e 	m	e	s
			if (command->m_sidemove > 777.f)
				command->m_sidemove = 777.f;
			else if (command->m_sidemove < -777.f)
				command->m_sidemove = -777.f;

			if (command->m_forwardmove > 777.f)
				command->m_forwardmove = 777.f;
			else if (command->m_forwardmove < -777.f)
				command->m_forwardmove = -777.f;
